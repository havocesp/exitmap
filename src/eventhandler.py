...
class Attacher(object):
    ...
    def _attach(self, stream_id=None, circuit_id=None):
        ...
        log.debug("Attempting to attach stream %s to circuit %s.", stream_id, circuit_id)
    ...
    def check_finished(self):
        ...
        with self.check_finished_lock:
            ...
            log.debug("failedCircs=%d, builtCircs=%d, totalCircs=%d, "
                      "finishedStreams=%d", self.stats.failed_circuits, self.stats.successful_circuits, self.stats.total_circuits, self.stats.finished_streams)
